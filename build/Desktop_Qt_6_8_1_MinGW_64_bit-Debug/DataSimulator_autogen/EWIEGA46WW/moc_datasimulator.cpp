...
namespace {
struct qt_meta_tag_ZN13DataSimulatorE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13DataSimulatorE = QtMocHelpers::stringData(
    "DataSimulator",
    "generateAndSendData",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13DataSimulatorE[] = {
...
Q_CONSTINIT const QMetaObject DataSimulator::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13DataSimulatorE.offsetsAndSizes,
    qt_meta_data_ZN13DataSimulatorE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13DataSimulatorE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<DataSimulator, std::true_type>,
        // method 'generateAndSendData'
...
void DataSimulator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->generateAndSendData(); break;
        default: ;
        }
    }
    (void)_a;
...
void *DataSimulator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13DataSimulatorE.stringdata0))
